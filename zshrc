...
# unlock server
alias unlock-ryzen='while ! $(nc -z 10.255.250.210 222); do sleep 1; done; ppers -c systems/ryzen-vmm01 && xclip -o -selection clipboard | ssh -p 222 root@10.255.250.210 cryptroot-unlock'
alias unlock-dev='while ! $(nc -z 10.255.250.211 222); do sleep 1; done; ppers -c systems/ryzen-dev-vm01 && xclip -o -selection clipboard | ssh -p 222 root@10.255.250.211 cryptroot-unlock'
